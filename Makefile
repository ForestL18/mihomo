...
GOBUILD=CGO_ENABLED=0 go build -tags with_gvisor -trimpath -ldflags '-X "github.com/forestl18/mihomo/constant.Version=$(VERSION)" \
		-X "github.com/forestl18/mihomo/constant.BuildTime=$(BUILDTIME)" \
		-w -s -buildid='
